...
public class MailSenderMultiProcessTest extends MailTestSupport {
    ...
    public void testExecuteNormalEndWithPatternId() throws Exception {
        ...
        VariousDbTestHelper.setUpTable(
                new MailRequestPatternMultiProcess(mailRequestId, subject, from, replyTo, returnPath, charset,
                        mailConfig.getStatusUnsent(), SystemTimeUtil.getTimestamp(), null, mailBody, "02", null),
                new MailRequestPatternMultiProcess("2", subject, from, replyTo, returnPath, charset, mailConfig.getStatusUnsent(),
                        SystemTimeUtil.getTimestamp(), null, mailBody, "01", null),
                new MailRequestPatternMultiProcess("3", subject, from, replyTo, returnPath, charset, mailConfig.getStatusUnsent(),
                        SystemTimeUtil.getTimestamp(), null, mailBody, "02", UUID.randomUUID().toString()));
